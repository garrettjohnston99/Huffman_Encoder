...
public class HuffEncoder {
    ...
    public static void main(String[] args) throws IOException{
        ...
        // Compress/decompress
        compressFile(huffmanTree, pathName);
    ...
    /**
     * Could just pass compressFile the code map but wanted same parameters for compress/decompress
     * @param huffmanTree Huffman code tree used to create codeMap character -> code
     * @param pathName
     */
    public static void compressFile(BinaryTree<HuffElement> huffmanTree, String pathName) throws IOException {
